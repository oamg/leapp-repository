...
def test_filter_out_pkgs_in_excluded_repos(monkeypatch, caplog):
    monkeypatch.setattr(api, 'show_message', show_message_mocked())
    monkeypatch.setattr(reporting, 'create_report', create_report_mocked())
    monkeypatch.setattr(peseventsscanner, 'get_repositories_excluded',
...
def test_process_events(monkeypatch):
    ...
    monkeypatch.setattr(peseventsscanner, 'get_repositories_excluded', get_repos_excluded_mocked(set()))
