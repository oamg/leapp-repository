...
def test_filter_out_pkgs_in_blacklisted_repos(monkeypatch, caplog):
    ...
    msg = (
        '2 packages will not be installed because they are available only in '
        'repositories which are either disabled or optional on RHEL8. The list '
        'of these packages (repositories: blacklisted):\n- skipped01\n- skipped02'
    )
