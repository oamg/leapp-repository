...
def map_repositories(packages):
    ...
    if repo_without_mapping:
        report_skipped_packages(
            title='Packages from unknown repositories may be not be installed',
            message='packages may be not be installed or upgraded due to repositories unknown to leapp:',
