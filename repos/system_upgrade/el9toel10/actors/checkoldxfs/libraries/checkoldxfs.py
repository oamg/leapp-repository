...
def _inhibit_upgrade(invalid_bigtime, invalid_crc):
    ...
    summary = ''.join([
        (
            'Some XFS filesystems on this system are incompatible with the RHEL 10'
    ...
    remediation_hint = (
        ...
        ' compatibility. For user data filesystems, perform a backup, reformat,'
    ...
    reporting.create_report([
        ...
        reporting.ExternalLink(
            ...
            url='https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html/managing_file_systems/restoring-an-xfs-file-system-from-backup_managing-file-systems'
        ),
