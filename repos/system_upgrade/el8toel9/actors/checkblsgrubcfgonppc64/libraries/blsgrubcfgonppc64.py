...
def process():
    ...
    if ff and ff.ppc64le_opal:
        reporting.create_report([
            ...
            reporting.Summary(
                'In-place upgrade to {} 9 is not supported on POWER8 and POWER9'
                ' bare metal systems. For more information, refer to the'
                ' following article: {}'.format(
                    DISTRO_REPORT_NAMES.target, URL
                )
            ),
