...
from leapp.models import MultipathConfFacts8to9, MultipathConfig8to9, TargetUserSpaceInfo
...
def test_all_facts(monkeypatch):
    ...
    monkeypatch.setattr(api, 'current_actor', CurrentActorMocked(msgs=[target_uspace_info]))
