...
# Requirement is SAP HANA 2.00 SPS05 rev 59.04 which is the minimal supported revision for both RHEL 8.6 and RHEL 9.0
# and SAP HANA 2.00 SPS06 rev 63 or later
            ...
            if sp == req_sp:
                ...
                if rev == req_rev:
                    ...
                    if patch_level < req_pl:
                        continue
                return True
        for requirements in SAP_HANA_RHEL8_REQUIRED_PATCH_LEVELS2:
            req_sp, req_rev, req_pl = requirements
            if sp == req_sp:
                rev = int(number.lstrip('0') or '0')
                if rev < req_rev:
