...
@pytest.mark.parametrize('a_file,name', [
    ...
    ('repos/system_upgrade/common/actors/targetcontentresolver/libraries/repomap_calc.py',
    ...
    ('repos/system_upgrade/common/actors/targetcontentresolver/libraries/repomap_loader.py',
     'target_content_resolver')
])
