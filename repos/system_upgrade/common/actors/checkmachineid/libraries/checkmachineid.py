...
def process():
    ...
    if machine_id_info.machine_id and _VALID_MACHINE_ID_RE.match(machine_id_info.machine_id):
        return
    ...
    reporting.create_report([
        ...
        reporting.Summary(
            ...
            ' 32-character hexadecimal machine ID. A valid machine-id is required'
            ' by systemd and is used during the upgrade to create the target'
            ' userspace container.'
        ),
