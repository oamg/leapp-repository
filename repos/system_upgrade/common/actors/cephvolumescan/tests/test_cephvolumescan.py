...
def test_encrypted_osds_list(m_get_ceph_lvm_list, m_isfile):
    ...
    assert cephvolumescan.encrypted_osds_list() == ['Tyc0TH-RDxr-ebAF-9mWF-Kh5R-YnvJ-cEcGVn', 'zcvGix-drzz-JwzP-6ktU-Od6W-N5jL-kxRFa3', 'Mz1dep-D715-Wxh1-zUuS-0cOA-mKXE-UxaEM3']
