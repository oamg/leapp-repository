...
def report_inhibitor(luks1_partitions, no_tpm2_partitions):
    ...
    if luks1_partitions:
        ...
        summary += (
            ...
            ' it has some limitations in comparison to LUKS2 and during initial'
            ' investigation we have decided to support for upgrades only LUKS2'
            ' format.'
            ' The following LUKS1 partitions have been discovered on your system:{}'
            .format(_formatted_list_output(luks1_partitions))
        )
    ...
    if no_tpm2_partitions:
        summary += (
            ...
            .format(_formatted_list_output(no_tpm2_partitions))
        )
