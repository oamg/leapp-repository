...
from leapp.libraries.common import repomap as peseventsscanner_repomap
...
def get_pesid_to_repoid_map(target_pesids, repositories_map_msg=None):
    """
...
def replace_pesids_with_repoids_in_packages(packages, source_pkgs_repoids, repositories_map_msg=None):
...
def process(repositories_map_msg=None, blacklisted_repoids=None):
    """
    ...
    :returns: RepositoriesSetupTasks to enable on the target system, or None if no PES events are found.
    :rtype: Optional[RepositoriesSetupTasks]
    """
