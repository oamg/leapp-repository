...
_CONFIG = {
    ...
    ("ol", "rhel"): [
        ...
        {"install": ["redhat-logos-httpd"], "remove": ["oracle-logos-httpd"]},
        {"install": ["redhat-logos-ipa"], "remove": ["oracle-logos-ipa"]},
        {"install": ["redhat-indexhtml"], "remove": ["oracle-indexhtml"]},
        {"install": ["redhat-backgrounds"], "remove": ["oracle-backgrounds"]},
    ],
    ("rocky", "rhel"): [
        {"install": ["redhat-indexhtml"], "remove": ["rocky-indexhtml"]},
    ],
    ("almalinux", "rhel"): [
        {"install": ["redhat-indexhtml"], "remove": ["almalinux-indexhtml"]},
    ],
}
